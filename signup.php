...
<head>
    ...
    <title>Sign Up as a Donar</title>
</head>
<body>
...
<div class="container">
  ...
  <h1 class="donarh">Registration</h1>

  <form class="sign" action="functions/addnewdonar.php" method="post">

   <label id="icon" for="name">Name:</label>
  <input type="text" name="name" id="name" placeholder="ie: omar" required/>  <br>
   <label id="icon" for="name">Number:</i></label>
  <input type="number" name="number" id="number" placeholder="ie: 0195" required/>  <br>
  <label id="icon" for="name">Email:</i></label>
  <input type="text" name="email" id="email" placeholder="ie: xyz@gmail.com" required/><br>
  <label id="icon" for="name">Age:</i></label>
  <input type="text" name="age" id="age" placeholder="ie: 27" required/><br>
  <label id="icon" for="name">Password:</i></label>
  <input type="password" name="password" id="password" placeholder="ie: #@6378_y7T" required/><br><br>
  <input id="submit" type="submit" value="Register">
     
   <p class="donar">Alredy a Donar? <a href="login.php">Login</a>.</p>
  </form>
</div>
